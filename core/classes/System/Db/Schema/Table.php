...
class Table
{
    ...
    {
        $this->fields[$field] = array('type' => 'int', 'length' => $length, 'nullable' => false, 'default' => false);
    ...
    {
        $this->fields[$field] = array('type' => 'float', 'length' => $length, 'nullable' => false, 'default' => false);
    ...
    {
        $this->fields[$field] = array('type' => 'date', 'nullable' => false, 'default' => false);
    ...
    {
        $this->fields[$field] = array('type' => 'text', 'length' => $length, 'nullable' => false, 'default' => false);

        return $this;
    }

    public function string($field, $length = 300)
    {
        $this->fields[$field] = array('type' => 'varchar', 'length' => $length, 'nullable' => false, 'default' => false);
    ...
    {
        $this->fields[$field] = array('type' => 'bool', 'length' => '1', 'nullable' => false, 'default' => false);
    ...
    public function create()
    {
        ...
        foreach ($this->fields as $field => $params) {
            $query_create .= '`' . $field . '` ' . self::getFieldType($params) . ' ' . ($params['default'] !== false ? 'DEFAULT ' . $params['default'] : '') . ' ' . (!$params['nullable'] ? 'NOT NULL' : '') . ' ' . ($params['type'] == 'increment' ? 'AUTO_INCREMENT' : '');
            $query_create .= ', ';
